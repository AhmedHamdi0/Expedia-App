...
class HiltonHotelManager(IReservationManager):
    def search(self, request: HotelRequest):
        ...
        hotels_external = HiltonHotelAPI.search_rooms(request.location, request.datetime_from, request.datetime_to, request.adults, request.children, request.num_rooms)
