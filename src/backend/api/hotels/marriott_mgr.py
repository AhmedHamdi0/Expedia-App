...
class MarriottHotelManager(IReservationManager):
    def search(self, request: HotelRequest):
        ...
        hotels_external = MarriottHotelAPI.search_available_rooms(request.location, request.datetime_from, request.datetime_to, request.adults, request.children, request.num_rooms)
